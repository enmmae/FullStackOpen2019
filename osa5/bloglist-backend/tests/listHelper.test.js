...
/* Values for the following tests */
...
describe('favorite blog', () => {
  ...
  test('of a bigger list is the first with most likes', () => {
...
describe('author with most blogs', () => {
  ...
  test('of a bigger list is the first author with most blogs', () => {
...
describe('author with most likes', () => {
  ...
  test('of a bigger list is the first author with most likes', () => {
